...
static TerrainType TDTREE8(TERRAINTD_TREE8, "t08", THEATERF_WINTERTD | THEATERF_TEMPERATETD | THEATERF_DESERTTD, false, false, Gdiplus::Size(1, 2), mask3, false);
static TerrainType TDTREE9(TERRAINTD_TREE9, "t09", THEATERF_DESERTTD, false, false, Gdiplus::Size(1, 2), mask3, false);
...
static TerrainType TDTREE18(TERRAINTD_TREE18, "t18", THEATERF_DESERTTD, false, false, Gdiplus::Size(2, 3), mask5, false);
...
static TerrainType TDCLUMP1(TERRAINTD_CLUMP1, "tc01", THEATERF_WINTERTD | THEATERF_TEMPERATETD, false, false, Gdiplus::Size(2, 3), mask6, false);
static TerrainType TDCLUMP2(TERRAINTD_CLUMP2, "tc02", THEATERF_WINTERTD | THEATERF_TEMPERATETD, false, false, Gdiplus::Size(2, 3), mask7, false);
static TerrainType TDCLUMP3(TERRAINTD_CLUMP3, "tc03", THEATERF_WINTERTD | THEATERF_TEMPERATETD, false, false, Gdiplus::Size(2, 3), mask8, false);
static TerrainType TDCLUMP4(TERRAINTD_CLUMP4, "tc04", THEATERF_WINTERTD | THEATERF_TEMPERATETD, false, false, Gdiplus::Size(3, 4), mask9, false);
static TerrainType TDCLUMP5(TERRAINTD_CLUMP5, "tc05", THEATERF_WINTERTD | THEATERF_TEMPERATETD, false, false, Gdiplus::Size(3, 4), mask10, false);
...
static TerrainType TDROCK3(TERRAINTD_ROCK3, "rock3", THEATERF_DESERTTD, false, false, Gdiplus::Size(2, 3), mask6, false);
static TerrainType TDROCK4(TERRAINTD_ROCK4, "rock4", THEATERF_DESERTTD, false, false, Gdiplus::Size(1, 2), mask3, false);
static TerrainType TDROCK5(TERRAINTD_ROCK5, "rock5", THEATERF_DESERTTD, false, false, Gdiplus::Size(1, 2), mask3, false);
static TerrainType TDROCK6(TERRAINTD_ROCK6, "rock6", THEATERF_DESERTTD, false, false, Gdiplus::Size(2, 3), mask12, false);
static TerrainType TDROCK7(TERRAINTD_ROCK7, "rock7", THEATERF_DESERTTD, false, false, Gdiplus::Size(1, 5), mask13, false);
...
static TerrainType RATREE8(TERRAINRA_TREE8, "t08", THEATERF_TEMPERATERA | THEATERF_SNOWRA, false, false, Gdiplus::Size(1, 2), mask3, true);
...
static TerrainType RACLUMP1(TERRAINRA_CLUMP1, "tc01", THEATERF_TEMPERATERA | THEATERF_SNOWRA, false, false, Gdiplus::Size(2, 3), mask6, true);
static TerrainType RACLUMP2(TERRAINRA_CLUMP2, "tc02", THEATERF_TEMPERATERA | THEATERF_SNOWRA, false, false, Gdiplus::Size(2, 3), mask7, true);
static TerrainType RACLUMP3(TERRAINRA_CLUMP3, "tc03", THEATERF_TEMPERATERA | THEATERF_SNOWRA, false, false, Gdiplus::Size(2, 3), mask8, true);
static TerrainType RACLUMP4(TERRAINRA_CLUMP4, "tc04", THEATERF_TEMPERATERA | THEATERF_SNOWRA, false, false, Gdiplus::Size(3, 4), mask9, true);
static TerrainType RACLUMP5(TERRAINRA_CLUMP5, "tc05", THEATERF_TEMPERATERA | THEATERF_SNOWRA, false, false, Gdiplus::Size(3, 4), mask10, true);
...
static TerrainType RAICE03(TERRAINRA_ICE03, "ice03", THEATERF_SNOWRA, false, false, Gdiplus::Size(1, 2), mask16, true);
static TerrainType RAICE04(TERRAINRA_ICE04, "ice04", THEATERF_SNOWRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RAICE05(TERRAINRA_ICE05, "ice05", THEATERF_SNOWRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RABOXES01(TERRAINRA_BOXES01, "boxes01", THEATERF_INTERIORRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RABOXES02(TERRAINRA_BOXES02, "boxes02", THEATERF_INTERIORRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RABOXES03(TERRAINRA_BOXES03, "boxes03", THEATERF_INTERIORRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RABOXES04(TERRAINRA_BOXES04, "boxes04", THEATERF_INTERIORRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RABOXES05(TERRAINRA_BOXES05, "boxes05", THEATERF_INTERIORRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RABOXES06(TERRAINRA_BOXES06, "boxes06", THEATERF_INTERIORRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RABOXES07(TERRAINRA_BOXES07, "boxes07", THEATERF_INTERIORRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RABOXES08(TERRAINRA_BOXES08, "boxes08", THEATERF_INTERIORRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RABOXES09(TERRAINRA_BOXES09, "boxes09", THEATERF_INTERIORRA, false, false, Gdiplus::Size(1, 2), mask3, true);
static TerrainType RAMINE(TERRAINRA_MINE, "mine", THEATERF_TEMPERATERA | THEATERF_SNOWRA, false, true, Gdiplus::Size(1, 2), mask3, true);
